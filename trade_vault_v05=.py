...
def main():
	...
	while True:
		try:
			user_prompt = int(
				input(
					'Type 1 to add trades, type 2 to upload historical trades from CSV, type 3 to view your performance, type 4 to quit: '))
			...
			if user_prompt == 1:
				...
				print('Values below 0 or above 4 are invalid. \nPick a number between 1, 2, 3, or 4. Please try again.\n')
			# Chose not to break it. Because I want the loop to keep reprompting users to write the correct value. Instead of rerunning it themselves manually.
